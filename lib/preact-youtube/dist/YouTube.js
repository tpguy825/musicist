...
var import_compat = __toESM(require("preact/compat"));
...
var _YouTube = class extends import_compat.default.Component {
  constructor(props) {
    super(props);
    ...
    this.createPlayer = () => {
      ...
      if (this.props.title || this.props.loading) {
        this.internalPlayer.getIframe().then((iframe) => {
          if (this.props.title)
            iframe.setAttribute("title", String(this.props.title));
          if (this.props.loading)
            iframe.setAttribute("loading", String(this.props.loading));
        });
      }
    };
  ...
  render() {
    return /* @__PURE__ */ import_compat.default.createElement("div", {
      className: this.props.className,
      style: this.props.style
    }, /* @__PURE__ */ import_compat.default.createElement("div", {
      id: this.props.id,
